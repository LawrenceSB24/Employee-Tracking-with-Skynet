...
VALUES ('Sales Lead', 200000.00, 1), -- 1 (manager id)

       ('Salesperson', 130000.00, 1), -- 2 (employee)

       ('Lead Engineer', 140760.00, 2), -- 3 (manager id)

       ('Software Engineer', 120000.00, 2), -- 4 (employeer)

       ('Account Manager', 125000.00, 3), -- 5 (manager id)

       ('Accountant', 45000.00, 3), -- (employee)

       ('Legal Team Lead', 240000.00, 4), -- 7 (manager id)

       ('Lawyer', 300000.00, 4), -- (employee)

       ('Lead Marketer', 210000.00, 5), -- 9 (manager id)

       ('Social Media Marketer', 100000.00, 5); -- 10 (employee)
